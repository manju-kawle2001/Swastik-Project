 ...
 * @author abc
 */
public class EmployeeLoginn extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
           ...
           EmployeeInformationDao vdao=new EmployeeInformationDao();
           vdao.setEmail(email);
           vdao.setPassword(password);
           
            
           EmployeeInformationDto vdto=new EmployeeInformationDto();
           boolean b=vdto.empLogin(vdao);
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(EmployeeLoginn.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
